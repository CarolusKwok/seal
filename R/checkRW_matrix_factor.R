#' Pre-check for r/w: Check the `factor` matrix if it suits the requirements
#'
...
#' @param func The function name that called this function, which is to be passed to `sys_msgerror` or `sys_msgwarning`. Default as `"ckrw_factor"`. If `NULL`, the function name will not display.
#'
...
ckrw_factor = function(factor, silent = FALSE, func = "ckrw_factor"){
