...
#' @noRd
#'
#' @examples sys_obtain_sheetdata(sheet = c("factor", "item", "data_1", "data_2")) #Should retrun "data_1" and "data_2"
sys_obtain_sheetdata = function(sheet){
...
#' @noRd
#'
#' @examples sys_obtain_sheetitem(sheet = c("factor", "item", "data_1", "data_2")) #Should return "item"
sys_obtain_sheetitem = function(sheet){
...
#' @noRd
#'
#' @examples sys_obtain_factor(colnames = c('@code', '#factor', 'item')) #Should return "#factor"
sys_obtain_factor = function(colnames){
...
#' @noRd
#'
#' @examples sys_obtain_factor(colnames = c('@code', '#factor', 'item')) #Should return "item"
sys_obtain_item = function(colnames){
